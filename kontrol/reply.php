...
<?php
    ...
    if(isset($_POST["reply"])){
        ...
        if($profile_pic != ""){
            $query = "UPDATE questions SET status = '1', replied_comment = '$description',replied_user = '$idusers',replied_file='$profile_pic' WHERE idquestions = '$idquestions'";
            $result = mysqli_query($con, $query);
        }
        else{
            $query = "UPDATE questions SET status = '1', replied_comment = '$description',replied_user = '$idusers' WHERE idquestions = '$idquestions'";
            $result = mysqli_query($con, $query);
        }
